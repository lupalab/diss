...
warnings.filterwarnings(
    "ignore", category=UserWarning, message="torch.sparse.SparseTensor"
)
...
class SVDKL(gpytorch.Module):
    def __init__(
        ...
        self.gp_layer = KISSGPLayer(
            num_dim=num_dim, grid_bounds=grid_bounds, grid_size=grid_size
        )
...
class SVDKLRegression(gpytorch.Module):
    def __init__(
        ...
        self.gp_layer = AdditiveKISSGPLayer(
            num_dim=num_features, grid_bounds=grid_bounds, grid_size=grid_size
        )
