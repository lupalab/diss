...
class NNSVGP(gpytorch.Module):
    def __init__(
        self, feature_extractor, inducing_points, likelihood=None, classification=False
    ):
        super(NNSVGP, self).__init__()
        self.feature_extractor = feature_extractor
        self.gp_layer = SVGPLayer(
            inducing_points=inducing_points, classification=classification
        )
...
class NNSVGPClassification(gpytorch.Module):
    def __init__(
        self, feature_extractor, num_inducing, num_classes, likelihood=None, num_dim=1
    ):
        super(NNSVGPClassification, self).__init__()
        self.feature_extractor = feature_extractor
        self.gp_layer = MultitaskGPLayer(
            output_dims=num_classes, num_inducing=num_inducing, input_dims=num_dim
        )
        self.likelihood = likelihood
