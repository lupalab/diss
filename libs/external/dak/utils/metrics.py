...
class RegressionMetrics:
    ...
    def nlpd(self):
        ...
        model_eval_at_test_x = gpytorch.distributions.MultivariateNormal(
            pred_mean, pred_var.diag(0)
        )
        ...
        nlpd_val = gpytorch.metrics.negative_log_predictive_density(
            trained_pred_dist, test_y
        ).item()  # a number
